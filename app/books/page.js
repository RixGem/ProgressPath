    ...
    return (
      <div className="flex items-center space-x-1">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`w-4 h-4 ${star <= rating ? 'text-yellow-400 fill-yellow-400 dark:text-yellow-500 dark:fill-yellow-500' : 'text-gray-300 dark:text-gray-600'}`}
          />
        ))}
      </div>
    )
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Track your reading progress</p>
        </div>
        <button
      ...
      <div className="grid gap-4">
        {books.length === 0 ? (
          <div className="card p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Start tracking your reading journey by adding your first book</p>
                    ...
                    {book.language_analysis && (
                      <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                        <div className="flex items-start">
                          ...
                          <div>
                            <div className="text-xs font-semibold text-blue-700 dark:text-blue-300 mb-1">语言分析</div>
